  ...
  "lib/optionSpecs": function (exports, require, module) {
    (function () {
      ...
      (ref1 = optionValidator.importances),
        (OPTIONAL = ref1.OPTIONAL),
        (REQUIRED = ref1.REQUIRED),
        (EVENTUALLY_REQUIRED = ref1.EVENTUALLY_REQUIRED),
        (PRIVATE = ref1.PRIVATE);
      BUTTON = "button";
      CUSTOM = "custom";
      STRING = "string";
      ...
      mixpanel.track = function (eventName, options) {
        ...
        if (
          !(
            typeof $ !== "undefined" &&
            $ !== null &&
            config.mixpanelKey != null
          )
        ) {
          return;
        }
        properties = $.extend(
          { token: config.mixpanelKey, userAgent: window.navigator.userAgent },
          options,
        );
        delete properties["stripe_token"];
        dataStr = base64.encode(
          JSON.stringify({ event: eventName, properties: properties }),
        );
        return (new Image().src =
          "https://api.mixpanel.com/track/?ip=1&img=1&data=" + dataStr);
      };
    ...
    (function () {
      ...
      FallbackRPC = (function () {
        ...
        FallbackRPC.prototype.invokeTarget = function (message) {
          var url;
          message =
            +new Date() + cacheBust++ + "&" + encodeURIComponent(message);
          url = this.host + "";
      ...
      App = (function () {
        ...
        App.prototype.trackOpen = function (checkout, options) {
          ...
          if (checkout.ab_fullscreen_mobile_iframe) {
            data.ab_fullscreen_mobile_iframe =
              checkout.ab_fullscreen_mobile_iframe;
          }
    ...
    (function () {
      ...
      Checkout = (function () {
        ...
        function Checkout(tokenCallback, options, configOptions) {
          ...
          var USE_SFSCV_FALLBACK_LIKELIHOOD,
            couldBeBrokenSFSVC,
          ...
          this.useFullscreenMobileView =
            ...
            (couldBeBrokenSFSVC &&
              isFullscreenMobileCapableViewport &&
              Math.random() < USE_SFSCV_FALLBACK_LIKELIHOOD);
          if (couldBeBrokenSFSVC && isFullscreenMobileCapableViewport) {
            this.ab_fullscreen_mobile_iframe = this.useFullscreenMobileView
              ? "on"
              : "control";
          }
          this.shouldPopup =
        ...
        Checkout.prototype.createView = function (useManhattan) {
          ...
          if (this.ab_fullscreen_mobile_iframe) {
            path =
              path +
              "&ab_fullscreen_mobile_iframe=" +
              this.ab_fullscreen_mobile_iframe;
          }
          ...
          cb = (function (_this) {
            return function () {
              ...
              if (_this.ab_fullscreen_mobile_iframe) {
                options.ab_fullscreen_mobile_iframe =
                  _this.ab_fullscreen_mobile_iframe;
              }
              options.supportsTokenCallback =
                _this.tokenCallback.supportsTokenCallback();
              iframeFallback = function () {
                ...
                _this.view = new IframeView(
                  _this.onToken,
                  _this.host,
                  "/v3/ENo08B7mC7MRAoNoFKW0KQ.html",
                );
      ...
      FallbackView = (function (superClass) {
        ...
        FallbackView.prototype.open = function (options, callback) {
          ...
          this.frame = window.open(
            url,
            "stripe_checkout_app",
            "width=400,height=400,location=yes,resizable=yes,scrollbars=yes",
          );
          if (this.frame == null) {
            alert("Disable your popup blocker to proceed with checkout.");
            url = "https://stripe.com/docs/checkout#integration-more-runloop";
            throw new Error(
              "To learn how to prevent the Stripe Checkout popup from being blocked, please visit " +
                url,
            );
          }
          this.rpc = new FallbackRPC(this.frame, url);
          this.rpc.receiveMessage(
            (function (_this) {
              return function (e) {
                var data, error;
                try {
