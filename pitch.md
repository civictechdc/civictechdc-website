...
<ul class="ctdc-partner-paths usa-list usa-list--unstyled">
  ...
  <li class="ctdc-partner-path">
    <h3 class="ctdc-partner-path__title">Real, measurable impact</h3>
    <p class="ctdc-partner-path__body">
      It has to help people, society, or the environment in a direct, measurable
      way. If we can't say who it helps and how we'd know, it isn't ready yet.
    </p>
  </li>
</ul>
...
<div class="ctdc-process">
  <div class="grid-container">
    <p class="ctdc-process__eyebrow">How a pitch becomes a project</p>
    <h2 class="ctdc-process__title">From a hunch to a team</h2>
    <ol class="ctdc-process__steps">
      ...
      <li class="ctdc-process__step">
        ...
        <div class="ctdc-process__content">
          <h3 class="ctdc-process__heading">It becomes a project</h3>
          <p class="ctdc-process__text">
            If it's a good fit, we help it find a home: someone who owns the
            problem to validate it, and a lead to drive it. Then we pitch it to
            our members at a Project Night to rally a team.
          </p>
        </div>
      </li>
      <li class="ctdc-process__step">
        ...
        <div class="ctdc-process__content">
          <h3 class="ctdc-process__heading">Build it</h3>
          <p class="ctdc-process__text">
            Your project comes to life at Project Nights, every two weeks,
            alongside people who want to help it succeed.
          </p>
        </div>
      </li>
    </ol>
