...
<ul class="ctdc-partner-paths usa-list usa-list--unstyled">
  <li class="ctdc-partner-path">
    <h3 class="ctdc-partner-path__title">Bring a problem or idea</h3>
    <p class="ctdc-partner-path__body">
      Nonprofits, legal clinics, journalists, researchers, community groups,
      residents, and civic technologists can start a private project
      conversation. You do not need a finished plan.
    </p>
    <a
      href="{{ site.baseurl }}/pitch"
      data-analytics-event="project_inquiry_click"
      data-analytics-location="homepage_pathways"
      >Start a project</a
    >
  </li>
  <li class="ctdc-partner-path">
    <h3 class="ctdc-partner-path__title">Help build useful technology</h3>
    <p class="ctdc-partner-path__body">
      Developers, designers, data practitioners, researchers, project managers,
      policy experts, and curious newcomers work together at Project Nights.
    </p>
    <a
  ...
  <li class="ctdc-partner-path">
    <h3 class="ctdc-partner-path__title">Validate or strengthen the work</h3>
    <p class="ctdc-partner-path__body">
      Problem owners, real users, subject-matter experts, hosts, connectors, and
      sponsors help projects stay grounded and sustainable.
    </p>
    <a
      href="{{ site.baseurl }}/partners"
      data-analytics-event="partner_discovery_click"
      data-analytics-location="homepage_pathways"
      >See ways to partner</a
    >
  </li>
</ul>
...
3. **Scope a feasible project.** Together, we define the public benefit, open-source approach, responsibilities, and a useful first milestone.
4. **Form a volunteer team.** If the project is a fit and there is enough leadership and capacity, we introduce it at a Project Night and work in the open.

Not every proposal becomes a Civic Tech DC project, and volunteer support is not a substitute for urgent, guaranteed, or ongoing commercial services. The [project intake page]({{ site.baseurl }}/pitch) explains fit, expectations, and what happens after the first conversation.
...
<ul>
  <li>
    <a
      href="{{ site.baseurl }}/projects/dc-reentry-housing-project.html"
      data-analytics-event="project_discovery_click"
  ...
  <li>
    <a
      href="{{ site.baseurl }}/projects/clean-slate.html"
      data-analytics-event="project_discovery_click"
      data-analytics-location="homepage_case_studies"
      >Clean Slate</a
    >
  ...
  <li>
    <a
      href="{{ site.baseurl }}/projects/data-and-democracy.html"
      data-analytics-event="project_discovery_click"
      data-analytics-location="homepage_case_studies"
