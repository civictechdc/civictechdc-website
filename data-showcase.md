...
<div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 40px; max-width: 1200px; margin: auto; padding-bottom: 40px;">
    <div style="width: calc(50% - 20px); min-width: 300px; max-width: 500px; text-align: center; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #ddd; box-sizing: border-box;">
        ...
        <img src="/assets/images/Data-Showcase-Projects/Environment-tool.png" style="width: 100%; height: auto; border-radius: 10px; margin-bottom: 20px;" alt="Environment Tool">
    ...
    <div style="width: calc(50% - 20px); min-width: 300px; max-width: 500px; text-align: center; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #ddd; box-sizing: border-box;">
        ...
        <img src="/assets/images/Data-Showcase-Projects/racial-equity.png" style="width: 100%; height: auto; border-radius: 10px; margin-bottom: 20px;" alt="Environment Tool">
        <p style="font-size: 1rem; line-height: 1.5;">
    ...
    <div style="width: calc(50% - 20px); min-width: 300px; max-width: 500px; text-align: center; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #ddd; box-sizing: border-box;">
        ...
        <img src="/assets/images/Data-Showcase-Projects/traffic-cameras.png" style="width: 100%; height: auto; border-radius: 10px; margin-bottom: 20px;" alt="Environment Tool">
        <p style="font-size: 1rem; line-height: 1.5;">
    ...
    <div style="width: calc(50% - 20px); min-width: 300px; max-width: 500px; text-align: center; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #ddd; box-sizing: border-box;">
        ...
        <img src="/assets/images/Data-Showcase-Projects/homeless-capacity.png" style="width: 100%; height: auto; border-radius: 10px; margin-bottom: 20px;" alt="Mapping Multidimensionality">
        <p style="font-size: 1rem; line-height: 1.5;">
...
<div style="display: flex; justify-content: center; align-items: center;">
    <div style="width: 90%; max-width: 500px; text-align: center; padding: 20px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #ddd; box-sizing: border-box; border-radius: 10px;">
        ...
        <img src="/assets/images/Data-Showcase-Projects/Mapping-multidimensionality.png" style="width: 100%; height: auto; border-radius: 10px; margin-bottom: 20px;" alt="Sample Image">
        <p style="font-size: 1rem; line-height: 1.5;">
