...
- Source images: stored in `_images` (often under subfolders like `_images/logos`); referenced by path *relative to the `_images` folder* in the `_includes/responsive-image.html` include.
...
<img src="/assets/images/project_thumbnails/opendatadc.png" alt="Open Data DC site">
```
