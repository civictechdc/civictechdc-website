...
<div class="ctdc-donate-cta">
  <ul class="usa-button-group ctdc-donate-cta__buttons">
    <li class="usa-button-group__item">
      <a class="usa-button ctdc-donate-btn-primary" href="https://donate.stripe.com/fZe00d7KM3y84c83cc" target="_blank" rel="noopener">Donate with Stripe</a>
    </li>
    <li class="usa-button-group__item">
      <a class="usa-button ctdc-donate-btn-outline" href="https://account.venmo.com/u/civic-tech-dc" target="_blank" rel="noopener">Donate with Venmo</a>
    </li>
  </ul>
